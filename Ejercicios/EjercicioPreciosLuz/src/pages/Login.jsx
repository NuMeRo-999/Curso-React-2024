...
const Login = ({setLogin}) => {
  ...
  const {data} = useDataApi('https://jsonplaceholder.org/users');
  ...
  function handleLogin(e) {
    ...
    if(data?.some(user => user.email === email)){
      if(data?.some(user => user.login.password === password)) {
        setLogin(true);
        navigate('/');
      } else setError('Contraseña incorrecta.'); // Pocho
    }else setError('Credenciales incorrectas.'); // Pocho
  }
